...
The reef-feed-aggregator service:
...
```
squid-ui → reef-feed-aggregator → reef-{eu|na|sa|asia}
```
...
# Docker build
docker build -t reef-feed-aggregator .

# Docker run
docker run -p 8080:8080 -e JWT_SECRET=footest reef-feed-aggregator
```
